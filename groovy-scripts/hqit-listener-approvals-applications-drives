// Approvals matrix depending on Customer request and Region - WWAPPS-3129 and Set Approvers for Applications & Drives
...
if (issue.issueTypeObject.name == "Data Change") {
    ...
    switch (drive) {
       case 'Accounting':
            apprv = [userUtil.getUserByKey('michael.grant'), userUtil.getUserByKey('chris.sweson')]
            loc = "\\\\10.251.70.100\\Shared\\Accounting Dept"
            break
        case 'Accounting Dept':
            apprv = [userUtil.getUserByKey('patrick.kelly')]
            loc = "\\\\10.251.70.100\\Shared\\Accounting Dept"
            break
        ...
        case 'Business Planning':
            apprv = [userUtil.getUserByKey('mike.nolan')]
        ...
        case 'Construction Accounting':
            ...
            break
        case 'Dalian':
            apprv = [userUtil.getUserByKey('jimmy.prinsky')]
            loc = ""
            break
        //case 'Enterprise':
        //    apprv = [userUtil.getUserByKey('conor.mccaffery')]
        //    loc = "\\\\10.251.70.100\\Shared\\Enterprise"
        //    break
        case 'Finance':
            log.debug "Finance Success"
            apprv = [userUtil.getUserByKey('michael.kopelman')]
            loc = "\\\\10.251.70.100\\Shared\\Finance"
            break
        case 'Financial Accounting':
            apprv = [userUtil.getUserByKey('michael.grant')]
            loc = ""
            break
        ...
        case 'Financial Reporting':
            apprv = [userUtil.getUserByKey('stephanie.tighe')]
            loc = ""
            break
        case 'Fixed Asset Accounting':
            apprv = [userUtil.getUserByKey('carmine.campo')]
            loc = ""
            break
        ...
        case 'Internal Controls':
            ...
            break
        case 'Legal':
            apprv = [userUtil.getUserByKey('pgreenspan')]
        ...
        case 'Office of the Chief Accounting Officer (OCAO)':
            apprv = [userUtil.getUserByKey('edgranaghan')]
            loc = "\\\\10.251.70.100\\Shared\\WeWork Legal"
            break
        case 'Operations':
            //apprv = [userUtil.getUserByKey('terry.wallace')]
            ...
            break
        case 'Payroll':
            apprv = [userUtil.getUserByKey('kevin.perry')]
            loc = "\\\\10.251.70.100\\Shared\\Shared Services\\People\\Payroll"
            break
        case 'Procurement':
            apprv = [userUtil.getUserByKey('rich.maddi')]
            loc = "\\\\10.251.70.100\\Shared\\weworkstaff\\Procurement"
            break
        case 'Product':
            apprv = [userUtil.getUserByKey('Tyson.A..Cadorette')]
            loc = ""
            break
        case 'Real Estate':
            apprv = [userUtil.getUserByKey('nicole.fitzgerald')]
            loc = "\\\\10.251.70.100\\Real Estate"
            break
        case 'Revenue Management':
            apprv = [userUtil.getUserByKey('florent.cailliau')]
            loc = "\\\\10.251.70.100\\shared\\revenue management"
            break
        case 'SAP (prodsap02)':
            apprv = [userUtil.getUserByKey('sharon.bitton')]
            loc = ""
            break
        ...
        case 'Shared Services Management':
            apprv = [userUtil.getUserByKey('greg.napolitan')]
        ...
        case 'SOX BPC':
            ...
            break
       case 'Tax':
            apprv = [userUtil.getUserByKey('paul.aronson')]
            loc = "\\\\10.251.70.100\\Shared\\accounting dept\\Tax"
            break
        case 'Treasury':
            apprv = [userUtil.getUserByKey('alex.agguire')]
